...
// TODO - убрать првязку к StreamingAssets

/// <summary>
/// Система локализации интерфейса
/// </summary>
public sealed class LocalizationUISystem : MonoBehaviour, ILocalizationUISystem
{
    [SerializeField] private string _uiPath;
    [SerializeField] private string _separator = "===";
    [SerializeField] private string _endLine = "</END>";

    public static ILocalizationUISystem instance { get; private set; }
    ...
    private void Awake()
    {
        ...
        UpdateUIText(LocalizationModes.SET, startLanguage);
    }

    public void UpdateUIText(LocalizationModes mode, string languageCode = "en")
    {
    ...
    public string GetCurrentLanguageText(string textKey)
    {
    ...
    private bool IsEmptyLocalizationFiles()
    {
    ...
    private bool IsEmptyLocalizationText()
    {
